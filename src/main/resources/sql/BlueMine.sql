...
(
  POSITIONNUM NUMBER(6) PRIMARY KEY
...
,CONSTRAINT FK_UI FOREIGN KEY(DEPARTMENT) REFERENCES CP_DEPARTMENT(DEPNUM)
  ON DELETE SET NULL
);
...
(
  ...
  ,CONSTRAINT FK_GW_GN FOREIGN KEY(GP_NUM)
   ...
   ON DELETE CASCADE
  ,CONSTRAINT CK_GW_PG CHECK(PROGRESS BETWEEN 0 AND 100)
...
(
  ...
  ,CONSTRAINT FK_PW_ID FOREIGN KEY(MEMBERID) 
   ...
   ON DELETE SET NULL
  ,CONSTRAINT CK_PW_PG CHECK(PROGRESS BETWEEN 0 AND 100)
