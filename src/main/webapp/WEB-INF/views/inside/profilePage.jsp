...
<!-- Modify css -->
 ...
 <script type="text/javascript" src="./resources/js/profilePage.js"></script>
</head>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			 <form name="updateProfile" class="form-horizontal">
			 <input type="hidden" id="userId" name="userId" value="${sessionScope.loginId}">
			 	<div class="form-group">
			 	  <label class="col-sm-2 control-label">Email</label>
			 	  <div class="col-sm-10">
			 	  	<input type="text" class="form-control" readonly="readonly" name="email" value="${updateUser.email}">
			 	  </div>
			 	</div>
			 	<div class="form-group">
			 	...
			 	<div class="form-group">
			 	  <label class="col-sm-2 control-label">Password <span>(Check)</span></label>
			 	  <div class="col-sm-10">
			 	...
			 	<div class="form-group">
			 	  ...
			 	  <div class="col-sm-10">
			 	  	<select class="form-control" id="department" name="department">
			 	  	  <c:forEach items="${sessionScope.dep_list}" var="dep">
			 	  	  	<option value="${dep.depNameKr}" >${dep.depNameKr}</option> 
			 	  	  </c:forEach>
			 	  	</select>
			 	  	<input type="hidden" value="${sessionScope.updateUser.department}" id="getDep">
			 	  </div>
			 	</div>
			 	<div class="form-group">
			 	  ...
			 	  <div class="col-sm-10">
			 	  	...
			 	  	<input type="hidden" value="${sessionScope.updateUser.position}" id="getPos">
			 	  </div>
			 	</div>
			  <input type="hidden" name="saveFile" id="saveFile" value="${sessionScope.updateUser.saveFile}">
			    <div class="form-group">
